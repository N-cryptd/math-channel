...
async function main() {
  ...
  const queries = [
    'what are exponents explained',
    'exponents visual intuition animation',
    'powers and exponents for beginners',
    'math antics exponents',
    'zero and negative exponents intuition',
  ];
  const all = [];
