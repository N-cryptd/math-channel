...
| 189 | Sturm-Liouville | 335 | YES | YES (section_divider+formula_box) | DONE | Added 5 section_divider (scenes 1-5). Added 3 formula_box (SL form, operator, expansion). setup_bg(2), play_intro(2), play_outro(2), progressive_reveal(8), SANS(28), ly.clear(9), safe_place(3). Zero .shift()/.to_edge() for content. |
