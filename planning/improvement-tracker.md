...
| 77 | Hypothesis Testing | 931 | YES | N/A (already v2) | N/A | Created with v2. setup_bg(2), progressive_reveal(8), section_divider(7), SANS(48), ly.clear(21), formula_box(4), safe_place(12). Zero .shift()/.to_edge(). 1 .move_to() (label at content_top, minor), 4 .move_to() on axes coordinates, 7 .next_to() all diagram/axis labels (acceptable). Script complete, not yet rendered. |
