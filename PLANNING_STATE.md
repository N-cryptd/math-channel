...
- Next up: Video 272 Fractions (content not started). Videos 270 + 271 renders complete (see their Notes rows).
...
- Video 271 (Negative Numbers) RENDERED 2026-09-03 (480p15, 328.0s, h264+aac, 10 TTS segments, audio mean -20.6 dB / peak -2.5 dB) → rendered/Video271_NegativeNumbers_narrated.mp4; render mtime > script mtime. Dot-grid pixel QA PASS (qa_dots v2 recalibrated this run: 100% dot-frame coverage, median 610 in-band px, no blank frames; tool validated positive on the 267/268/269/270 renders and negative on flat-bg/white synthetics — the previous per-region criterion was unachievable and scored known-good 269 at 0%). Known issue: 6/10 TTS segments need 1.6–2.6x speedup (scene slots shorter than natural narration — same add_subcaption pacing pitfall as 267/268); pacing fix task queued.
