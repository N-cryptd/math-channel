...
class Video118_DirectProductsFiniteAbelian(Scene):
    ...
    def scene1_hook(self):
        self.add_subcaption(
            ...
            duration=29.5,  # natural 28.75 + 0.7 drift margin (t_3c7eef2e)
        )
        ...
        self.wait(10.5)  # pacing: extends caption slot to >= natural+1.0 (t_3c7eef2e)
    ...
    def scene2_definition(self):
        self.add_subcaption(
            ...
            duration=58.4,  # natural 57.67 + 0.7 (t_3c7eef2e)
        )
        ...
        self.wait(22.6)  # pacing: extends caption slot (t_3c7eef2e)
    ...
    def scene3_cyclic_product(self):
        self.add_subcaption(
            ...
            duration=57.8,  # natural 57.05 + 0.7 (t_3c7eef2e)
        )
        ...
        self.wait(17.0)  # pacing: extends caption slot (t_3c7eef2e)
    ...
    def scene4_properties(self):
        self.add_subcaption(
            ...
            duration=45.6,  # natural 44.93 + 0.7 (t_3c7eef2e)
        )
        ...
        self.wait(19.7)  # pacing: extends caption slot (t_3c7eef2e)
    ...
    def scene5_internal_product(self):
        self.add_subcaption(
            ...
            duration=52.4,  # natural 51.67 + 0.7 (t_3c7eef2e)
        )
        ...
        self.wait(21.7)  # pacing: extends caption slot (t_3c7eef2e)
    ...
    def scene6_classification_statement(self):
        self.add_subcaption(
            ...
            duration=55.6,  # natural 54.94 + 0.7 (t_3c7eef2e)
        )
        ...
        self.wait(9.8)  # pacing: extends caption slot (t_3c7eef2e)
    ...
    def scene7_classification_examples(self):
        self.add_subcaption(
            ...
            duration=62.2,  # natural 61.49 + 0.7 (t_3c7eef2e)
        )
        ...
        self.wait(7.5)  # pacing: extends caption slot (t_3c7eef2e)
    ...
    def scene8_summary(self):
        self.add_subcaption(
            ...
            "Thanks for watching.",
            duration=46.7,  # natural 45.98 + 0.7 (t_3c7eef2e)
        )
        ...
        self.wait(28.0)  # pacing: extends caption slot incl. outro (t_3c7eef2e)
